            ...
            <div className="my-5">
                <div className="card px-4 py-3 w-75 mx-auto  shadow-sm">
                    <div className="row py-1 mb-4 text-center">
                        <div className="col-md-6">
                            <h4 className=" text-start" style={{color:'#0E8A8A'}}>Doctor Register</h4>
                        </div>
                        <div className="col-md-6 pt-2 pe-1">
                            <h6 className=" text-end"><Link className=" text-decoration-none" to="/PatientsRegistration"  style={{color:'#ff9600'}}>Not a Doctor ?</Link></h6>
                        </div>
                    </div>
                    ...
                    <div className='text-center mt-2'>
                        <p> Already have an account 
                            <Link className=" text-decoration-none" to="/DrsLogin">
